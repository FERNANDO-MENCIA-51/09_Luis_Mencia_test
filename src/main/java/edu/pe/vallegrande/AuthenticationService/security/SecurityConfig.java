...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http,
            org.springframework.web.cors.reactive.CorsWebFilter corsWebFilter) {
        return http
                // Deshabilitar CSRF (no necesario para APIs REST con JWT)
                .csrf(ServerHttpSecurity.CsrfSpec::disable)

                // Agregar filtro CORS ANTES de la autenticación
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        // Endpoints de Document Types - Público (lectura)
                        .pathMatchers(HttpMethod.GET, "/api/v1/document-types/**").permitAll()

                        // Endpoints de Users - Requieren autenticación
                        .pathMatchers(HttpMethod.GET, "/api/v1/users/**")
                        .hasAnyRole("ADMIN", "USER_MANAGER", "VIEWER", "SUPER_ADMIN")
                        ...
                        .hasAnyRole("ADMIN", "USER_MANAGER", "VIEWER", "SUPER_ADMIN")
                        .pathMatchers(HttpMethod.POST, "/api/v1/persons")
                        .hasAnyRole("SUPER_ADMIN", "ADMIN", "USER_MANAGER")
                        .pathMatchers(HttpMethod.PUT, "/api/v1/persons/**")
                        .hasAnyRole("SUPER_ADMIN", "ADMIN", "USER_MANAGER")
                        .pathMatchers(HttpMethod.PATCH, "/api/v1/persons/**")
                        .hasAnyRole("SUPER_ADMIN", "ADMIN", "USER_MANAGER")
                        ...
                        .pathMatchers(HttpMethod.GET, "/api/v1/permissions/**")
