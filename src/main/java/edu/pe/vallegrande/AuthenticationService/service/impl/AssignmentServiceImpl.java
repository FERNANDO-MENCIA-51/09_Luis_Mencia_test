...
public class AssignmentServiceImpl implements AssignmentService {
    ...
    public Mono<Void> removePermissionFromRole(UUID roleId, UUID permissionId) {
        ...
        return rolePermissionRepository.findByRoleIdAndPermissionId(roleId, permissionId)
                .switchIfEmpty(Mono.error(new ResourceNotFoundException("Asignación no encontrada")))
    ...
    @Override
    public Mono<RolePermissionAssignmentDto> restorePermissionToRole(UUID roleId, UUID permissionId) {
        log.info("Restaurando permiso {} al rol {}", permissionId, roleId);
        ...
        return rolePermissionRepository.findByRoleIdAndPermissionId(roleId, permissionId)
                ...
                .map(this::mapRolePermissionToDto)
                .doOnSuccess(assignment -> log.info("Permiso restaurado exitosamente: {} -> {}", roleId, permissionId));
    }
