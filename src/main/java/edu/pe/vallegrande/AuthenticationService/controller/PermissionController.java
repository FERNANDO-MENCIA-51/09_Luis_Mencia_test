 ...
 * Los permisos definen las acciones que pueden realizar los roles en el
 * sistema.
 */
@Slf4j
@RestController
...
public class PermissionController {
        ...
        /**
         * Obtener todos los permisos del sistema con filtros opcionales
         * 
         * @param module Filtro opcional por módulo
         * @param status Filtro opcional por estado (true/false)
         * @return Lista de permisos filtrados
         */
        ...
        public Flux<PermissionResponseDto> getAllPermissions(
                ...
                log.info("Consultando permisos con filtros - module: {}, status: {}", module, status);

                return permissionService.getAllPermissions(module, status)
                                .map(this::mapToResponseDto)
